x=int(input("Hello World! How deep a tree do you wish for? And pleas make it an whole numbrer. ")) #Starter lige med at sige hej.
...
if 13>x>=1: #For alle træer med minimum 1 branches til 6. 
    l(90)
    tree(len,x)
